...
namespace BlazorStore.Data.Models
{
    public class _PayPalResponse
    {
        ...
        public static _PayPalResponse Success(string tx)
        {
        ...
        static _PayPalResponse Parse(string postData)
        {
            string sKey, sValue;
            _PayPalResponse payPalResponse = new();
            try
            {
